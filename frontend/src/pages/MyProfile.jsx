...
const MyProfile = () => {
  const { user, token, updateUserProfile, getUserProfile } =
        ...
        {isEdit ? (
          <div className="flex gap-3">
            <button
              disabled={saving}
              onClick={onSave}
              className="border border-blue-900 px-6 py-2 rounded-full bg-blue-600 text-white"
            >
              {saving ? "Saving..." : "Save"}
            </button>
            <button
          ...
          <button
            className="border border-blue-900 px-8 py-2 rounded-full hover:bg-blue-900 hover:text-white transition-all"
